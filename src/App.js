...
const linkData = [
  { thumbnail: 'campinn.jpg', title: 'DJ Contest', subtitle: 'Checkout my entry for the Dirtybird DJ Contest!', url: 'https://player-widget.mixcloud.com/widget/iframe/?light=1&autoplay=1&feed=%2FJonMoniker%2Fdirtybird-campinn-2025-dj-contest-jon-moniker%2F', ctaText: 'LISTEN', embed: true, embedHeight: '200px' },
